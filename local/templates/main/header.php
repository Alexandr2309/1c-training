...
<head>
    ...
    Asset::getInstance()->addJs(SITE_TEMLATE_PATH . "/assets/js/vendor/jquery-1.12.0.min.js");
    Asset::getInstance()->addJs(SITE_TEMLATE_PATH . "/assets/js/bootstrap.min.js");
    Asset::getInstance()->addJs(SITE_TEMLATE_PATH . "/assets/js/owl.carousel.min.js");
    Asset::getInstance()->addJs(SITE_TEMLATE_PATH . "/assets/js/jquery.counterup.min.js");
    Asset::getInstance()->addJs(SITE_TEMLATE_PATH . "/assets/js/waypoints.min.js");
    Asset::getInstance()->addJs(SITE_TEMLATE_PATH . "/assets/js/jquery.magnific-popup.min.js");
    Asset::getInstance()->addJs(SITE_TEMLATE_PATH . "/assets/js/jquery.mixitup.min.js");
    Asset::getInstance()->addJs(SITE_TEMLATE_PATH . "/assets/js/jquery.meanmenu.js");
    Asset::getInstance()->addJs(SITE_TEMLATE_PATH . "/assets/js/jquery.nav.js");
    Asset::getInstance()->addJs(SITE_TEMLATE_PATH . "/assets/js/jquery.parallax-1.1.3.js");
    Asset::getInstance()->addJs(SITE_TEMLATE_PATH . "/assets/js/animate-text.js");
    Asset::getInstance()->addJs(SITE_TEMLATE_PATH . "/assets/js/plugins.js");
    Asset::getInstance()->addJs(SITE_TEMLATE_PATH . "/assets/js/main.js");
    ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-3 col-xs-8">
                        <div class="logo ptb-22">
                            <a href="<?= SITE_TEMPLATE_PATH ?>/assets/index.html">
                ...
                <div class="col-md-12">
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul>
                                <li>
                                    <a href="<?= SITE_TEMPLATE_PATH ?>/assets/index.html">Главная</a>
                                </li>
                                <li>
                                    <a href="<?= SITE_TEMPLATE_PATH ?>/assets/about_us.html">О нас</a>
                                </li>
                                <li>
                                    <a href="<?= SITE_TEMPLATE_PATH ?>/assets/services.html">Услуги</a>
                                    <ul>
                                        <li>
                                            <a href="<?= SITE_TEMPLATE_PATH ?>/assets/services_landing.html">Лендинг</a>
                                        </li>
                                        <li>
                                            <a href="<?= SITE_TEMPLATE_PATH ?>/assets/services_online_shop.html">Интернет-магазин</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>                                    <a href="<?= SITE_TEMPLATE_PATH ?>/assets/portfolio.html">Портфолио</a>                                </li>

                                <li>
                                    <a href="<?= SITE_TEMPLATE_PATH ?>/assets/blog.html">Блог</a>
                                </li>
                                <li>
                                    <a href="<?= SITE_TEMPLATE_PATH ?>/assets/contacts.html">Контакты</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
